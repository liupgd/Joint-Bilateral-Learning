...
if __name__ == '__main__':
    ...
    parser.add_argument('--cont_img_path', type=str, default="/mnt/DataDisk/public/dataset/COCO/2017/images/test2017", help='path to content images')
    parser.add_argument('--style_img_path', type=str, default="/mnt/DataDisk/public/dataset/COCO/2017/images/val2017", help='path to style images')
